<audio title="07｜类型转换：V8是怎么实现1+“2”的？" src="https://static001.geekbang.org/resource/audio/90/5c/90577bbf77f238c7a7ac2a56bb048a5c.mp3" controls="controls"></audio> 
...
</code></pre><p>V8会严格根据ECMAScript规范来执行操作。ECMAScript是一个语言标准，JavaScript就是ECMAScript的一个实现，比如在ECMAScript就定义了怎么执行加法操作，如下所示：</p><p><img src="https://static001.geekbang.org/resource/image/2d/98/2d483835d08d2a9d5143d26e09ad4a98.png?wh=1720*1106" alt="" title="ECMAScript定义加法语义"></p><p>具体细节你也可以<a href="https://www.ecma-international.org/ecma-262/6.0/index.html#sec-addition-operator-plus-runtime-semantics-evaluation">参考规范</a>，我将标准定义的内容翻译如下：</p><blockquote>
...
</ul><p>将对象转换为原生类型的流程图如下所示：</p><p><img src="https://static001.geekbang.org/resource/image/d1/aa/d150309b74f2c06e66011cf3e177dbaa.jpg?wh=2284*1285" alt=""></p><p>当V8执行1+“2”时，因为这是两个原始值相加，原始值相加的时候，如果其中一项是字符串，那么V8会默认将另外一个值也转换为字符串，相当于执行了下面的操作：</p><pre><code>Number(1).toString() + &quot;2&quot;
